  ...
  return (
    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        >
          A Frontend Developer crafting responsive and user-friendly React
          interfaces
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <a
            download="Samaneh_Bakhshi.pdf"
            href="/files/Samaneh_Bakhshi_Front_End_Developer_Resume (1).pdf"
